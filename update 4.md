```mermaid
---
title: Arquitectura de calificación de leads, atención al cliente y captura de datos de venta (V2 Optimizada)
---
graph TD
    ...
    %% Capa 1: RAG Dinámico (Ahorro de Tokens)
    ...
    JSONResponse --> SentimentCheck{¿Sentimiento <br/>Negativo?}
